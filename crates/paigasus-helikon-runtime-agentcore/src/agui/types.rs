...
// The AG-UI mapper and endpoints (SMA-461 Tasks 5-7) call these to build outbound
// SSE/WebSocket frames. Until they land, only this module's own tests call them.
// Remove this module-level `allow` once those callers land.
#[allow(dead_code)]
pub(crate) mod event {
