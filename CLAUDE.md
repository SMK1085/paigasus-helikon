...
- **MSRV is `1.91`** (workspace-package level; raised from 1.85 in SMA-329 because aws-config/aws-sdk-bedrockruntime/aws-smithy-* crates declare MSRV 1.91.1). If a dep raises MSRV, bump `rust-version` to what cargo demands rather than downgrading the dep.
